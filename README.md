...
A playable browser prototype for a Carrom game focused on core striker + coin interaction, with a basic AI opponent, scoring, Japanese UI text, and player setup options.
...
- **19 total coins** on the board (9 white, 9 black, and 1 red coin)
...
- AI prioritizes its own color and avoids pocketing player-color coins
- Player name input before game start
- Player color choice (AI gets the opposite color)
- Live point calculation and score display under each player name (red coin = 5 points)
...
Before launching, you can optionally validate the script syntax:
...
9. Confirm AI behavior prioritizes its own color coins
10. Confirm you can drag below board area to reach full power
...
- Press **Reset Board** to restart with 19 coins
